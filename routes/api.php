...
Route::middleware(['throttle:api'])->group(function () {
    ...
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        Route::group([], function () {
            Route::get('/points', [PointController::class, 'index'])->name('points_details.index');
            Route::put('/points', [PointController::class, 'update'])->name('points.update');
            Route::delete('/points', [PointController::class, 'delete'])->name('points.delete');
            Route::post('/students/{student}/points', [StudentPointController::class, 'store'])->name('points.store');
            Route::get('/students/{student}/points', [StudentPointController::class, 'index'])->name('points.index');
            Route::get('/students/{student}/points/{point}', [StudentPointController::class, 'show'])->name('points.show');
            Route::delete('/students/{student}/points/{point}', [StudentPointController::class, 'delete'])->name('points.delete');
            Route::put('/students/{student}/points/{point}', [StudentPointController::class, 'update'])->name('points.update');
        });
